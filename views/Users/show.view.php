                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex space-between">
                                <a class=" btn btn-sm btn-secondary p-2 m-1" href="/user"><i class='bx bx-arrow-back'></i> Back</a>
                                <a class=" btn btn-sm btn-warning p-2 m-1" href="/user/edit?id=<?= $user['UUID'] ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
